...
variable "nfs_export_path" {
  description = "Path to directory that will be shared over NFS."
  type = string
  default = "/share"
}

variable "nfs_export_string" {
  description = "Host string passed to /etc/exports. Be granular with this configuration - any machine matching this condition will have rw access to the nfs directory."
  type = string
}
...
| <a name="input_ipconfig"></a> [ipconfig](#input\_ipconfig) | IP address to assign to the guest. Format: [gw=<GatewayIPv4>] [,gw6=<GatewayIPv6>] [,ip=<IPv4Format/CIDR>] [,ip6=<IPv6Format/CIDR>]. | `string` | n/a | yes |
